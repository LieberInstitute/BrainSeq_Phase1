...
# covsDer = SlicedData$new(t(cbind(mod[,-1], pcsDer)))
...
# save(meDerCis, nsvDer, pcsDer, file="rdas/der_eqtl_control_13plus_cisOnly.rda")
...
length(unique(eqtl$der[eqtl$bonf < 0.05])) # 16374
...
# save output
save(sigDer, file="rdas/annotated_der_eqtl_control_13plus_cisOnly.rda")
