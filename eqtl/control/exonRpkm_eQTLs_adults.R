...
# covsExon = SlicedData$new(t(cbind(mod[,-1],pcsExon )))
...
# save(meExonCis, nsvExon, pcsExon, file="rdas/exon_eqtl_control_13plus_cisOnly.rda")
...
save(sigExon, file="rdas/annotated_exon_eqtl_control_13plus_cisOnly.rda")
